                    ...
                    case true:
                        {
                            if (PostObject != null)
                            {
                                ...
                                StreamRateLevel.SetImageURI(Android.Net.Uri.Parse(PostObject.Owner?.OwnerClass?.Avatar));
                    ...
                    default:
                        {
                            if (LiveStreamViewerObject != null)
                            {
                                ...
                                StreamRateLevel.SetImageURI(Android.Net.Uri.Parse(LiveStreamViewerObject.Owner?.OwnerClass?.Avatar));
...
#pragma warning restore 618
        ...
        public void OnSelection(IDialogInterface dialog, int position, string itemString)
        {
            try
            {
                ...
                //    {
                //        case true:
                //            AppTools.OpenProfile(this, PostObject.Owner?.OwnerClass?.UserId, PostObject.Publisher);
                //            break;
                //        default:
                //            AppTools.OpenProfile(this, LiveStreamViewerObject.Owner?.OwnerClass?.UserId, LiveStreamViewerObject.Publisher);
                //            break;
                //    }
                //}
                //else 
