            ...
            try
            {
                if (viewHolder is ManageSessionsAdapterViewHolder holder)
                {
                    ...
                    if (item != null)
                    {
                        ...
                        {
                            if (item.Browser == "Mobile")
                            {
                                holder.Image.SetImageResource(Resource.Drawable.pif_phone_fill);
                            }
                            else
                            {
                                holder.Image.SetImageResource(Resource.Drawable.pif_desktop_filled);
                            }
